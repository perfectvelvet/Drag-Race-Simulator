...
let olivia = new Queen("Olivia Lux", 8, 5, 9, 9, 4, 9, 10, "Olivia");
let rose = new Queen("Rosé", 10, 9, 12, 8, 9, 7, 6, "Rose");
let symone = new Queen("Symone", 12, 8, 7, 7, 12, 9, 13, "Symone");
...
//SEASON 14:
let alyssaH = new Queen("Alyssa Hunter", 5, 7, 8, 9, 7, 11, 8, "AlyssaH");
let angeria = new Queen("Angeria Paris VanMicheals", 10, 9, 8, 10, 6, 10, 8, "Angeria");
let bosco = new Queen("Bosco", 10, 9, 6, 7, 7, 9, 7, "Bosco");
let daya = new Queen("Daya Betty", 9, 6, 9, 9, 8, 10, 7, "DayaBetty");
let deja = new Queen("DeJa Skye", 8, 7, 8, 8, 10, 7, 8, "DeJa");
let jasmineK = new Queen("Jasmine Kennedie", 8, 6, 9, 7, 6, 8, 13, "JasmineK");
let jorgeous = new Queen("Jorgeous", 5, 6, 10, 7, 6, 9, 12, "Jorgeous");
let june = new Queen("June Jambalaya", 7, 7, 8, 5, 7, 6, 6, "June");
let kerri = new Queen("Kerri Colby", 6, 7, 6, 5, 7, 9, 7, "Kerri");
let kornbread = new Queen("Kornbread Jeté", 7, 8, 7, 6, 7, 8, 7, "Kornbread");
let cadmen = new Queen("Lady Camden", 9, 8, 10, 9, 6, 8, 10, "LadyCamden");
let maddy = new Queen("Maddy Morphosis", 8, 7, 6, 5, 8, 8, 7, "Maddy");
let orion = new Queen("Orion Story", 5, 7, 7, 7, 6, 7, 6, "Orion");
let willow = new Queen("Willow Pill", 9, 8, 7, 10, 8, 11, 8, "Willow");
...
//CAN SEASON 2
let adriana = new Queen("Adriana", 9, 6, 8, 7, 6, 8, 6, "Adriana");
let beth = new Queen("Beth", 5, 5, 6, 5, 6, 6, 4, "Beth");
let eve = new Queen("Eve 6000", 10, 5, 5, 6, 6, 8, 8, "Eve");
let giametric = new Queen("Gia Metric", 9, 6, 10, 6, 6, 9, 10, "Giametric");
let icesis = new Queen("Icesis Couture", 7, 9, 8, 11, 7, 10, 10, "Icesis");
let kendall = new Queen("Kendall Gender", 7, 9, 9, 6, 6, 8, 9, "Kendall");
let kimoraA = new Queen("Kimora Amour", 7, 5, 5, 6, 7, 7, 5, "KimoraA");
let oceane = new Queen("Océane Aqua-Black", 6, 7, 4, 7, 7, 7, 6, "Oceane");
...
let synthia = new Queen("Synthia Kiss", 6, 8, 10, 7, 9, 7, 10, "Synthia");
...
let janey = new Queen("Janey Jacké", 8, 7, 10, 12, 6, 11, 10, "Janey");
let madamem = new Queen("Madame Madness", 6, 6, 6, 8, 5, 9, 7, "MadameM");
let mama = new Queen("Ma'Ma Queen", 8, 7, 5, 8, 7, 10, 6, "Mama");
let megan = new Queen("Megan Schoonbrood", 7, 8, 7, 5, 6, 8, 11, "Megan");
let abby = new Queen("Miss Abby OMG", 9, 8, 12, 7, 6, 8, 10, "Abby");
let patty = new Queen("Patty Pam-Pam", 8, 6, 6, 9, 8, 9, 7, "Patty");
let roem = new Queen("Roem", 8, 8, 5, 5, 7, 6, 5, "Roem");
let sederginne = new Queen("Sederginne", 8, 6, 6, 10, 6, 13, 5, "Sederginne");
...
let anita = new Queen("Anita Wigl'it", 9, 9, 8, 7, 9, 8, 7, "Anita");
let art = new Queen("Art Simone", 5, 5, 6, 9, 4, 10, 2, "Art");
let cocoj = new Queen("Coco Jumbo", 6, 6, 8, 5, 5, 7, 9, "CocoJ");
let elektra = new Queen("Elektra Shock", 8, 9, 9, 6, 7, 7, 10, "Elektra");
let etc = new Queen("Etcetera Etcetera", 7, 8, 8, 7, 7, 9, 8, "Etc");
let jojo = new Queen("Jojo Zaho", 5, 5, 6, 7, 5, 6, 8, "Jojo");
let karen = new Queen("Karen From Finance", 6, 5, 7, 6, 5, 7, 5, "Karen");
let kita = new Queen("Kita Mean", 8, 8, 7, 7, 9, 9, 10, "Kita");
let maxi = new Queen("Maxi Shield", 7, 6, 6, 9, 7, 8, 9, "Maxi");
